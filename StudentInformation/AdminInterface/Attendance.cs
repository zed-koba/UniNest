...
namespace StudentInformation.AdminInterface
{
    public partial class Attendance : UserControl
    {
        ...
        private void ViewProfile_Clicked(int rowNum)
        {
            ...
            int student_ID = Convert.ToInt32(selectedRow.Cells["studentID"].Value);
            Student_Attendance show_Attendance = new Student_Attendance(student_ID);

            this.Parent.Controls.Add(show_Attendance);
            show_Attendance.Dock = DockStyle.Fill;
            show_Attendance.BringToFront();
        }
