...
namespace StudentInformation.AdminInterface
{
    public partial class Education : UserControl
    {
        ...
        private void Education_Load(object sender, EventArgs e)
        {
            ...
            loadStudents("SELECT * FROM Students WHERE currentStatus = 0 OR currentStatus = 1");
        ...
        private void ViewProfile_Clicked(int rowNum)
        {
            ...
            try
            {
                using (EditEducation resetForm = new EditEducation(Convert.ToInt32(selectedRow.Cells["studentID"].Value), this.Parent.Parent.Location))
                {
